...
return new class extends Migration
{
    public function up()
    {
        Schema::create('pegawai_pns', function (Blueprint $table) {
            ...
            $table->string('eselon')->nullable(); // Level Eselon (I, II, dst)
            
            // Perbaikan: Eselon 1-4 sebagai kolom terpisah
            ...
            // Kolom ini tetap ada sebagai default awal jika tidak ada riwayat
            $table->integer('jatah_cuti_tahunan')->default(12);
            $table->integer('sisa_cuti_tahun_lalu')->default(6); 
            $table->timestamps();
        });
    }

...
@section('content')
    ...
    <style>
        /* =========================================
               STYLE TAMBAHAN (DARI KODE ANDA & TEMAN)
               ========================================= */
        ...
        /* --- FORM ELEMENTS (Fix Mobile Input) --- */
        .form-control-custom {
            ...
            /* [PERBAIKAN MOBILE ANDA] Background putih & text gelap agar input date terlihat */
            background-color: #ffffff;
            color: #334155;
            min-height: 48px;
            /* Tinggi yang nyaman untuk sentuhan jari */
        }
        ...
        /* [PERBAIKAN MOBILE ANDA] CSS agar icon kalender & teks tanggal muncul benar di HP */
        input[type="date"] {
        ...
        /* --- FIX TOMBOL & LAYOUT MOBILE ONLY (DARI ANDA) --- */
        @media (max-width: 767.98px) {
            ...
            /* [TAMBAHAN BARU] Fix Lebar Kolom Tabel Mobile */
            /* Agar 'Jenis Cuti' bisa turun baris (wrap) dan tidak mendorong kolom lain */
            .col-jenis-cuti {
            ...
            /* Kolom lain tetap satu baris agar rapi */
            .col-nowrap {
                white-space: nowrap;
            }
        }
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 mb-md-5 fade-in-up mobile-header-align">
        ...
        <div class="d-none d-md-flex align-items-center bg-white px-4 py-2 rounded-pill shadow-sm border">
            ...
            <div class="rounded-circle bg-light d-flex align-items-center justify-content-center text-bnpb-orange fw-bold shadow-sm"
                ...
                <div class="card-body p-4">
                    ...
                    @if (session('error'))
                        <div class="alert alert-danger border-0 d-flex align-items-center mb-4 shadow-sm" role="alert"
                            style="background-color: #fee2e2; color: #b91c1c; border-radius: 10px;">
                    ...
                    <form id="searchForm" action="{{ route('cek-cuti.check') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-custom border-start-0 rounded-end-3"
                                    id="keyword" name="keyword" placeholder="Masukkan NIP atau Nama Lengkap..."
                                    value="{{ old('keyword', $data['pegawai']->nip ?? '') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-custom" id="tgl_dari"
                                    name="tgl_dari"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-custom" id="tgl_sampai"
                                    name="tgl_sampai"
                        ...
                        <div class="d-flex gap-2 gap-md-3">
                            <button type="submit" class="btn btn-bnpb-primary btn-mobile-fix flex-grow-1 flex-md-grow-0"
                                id="btnCari">
                            ...
                            @if (isset($data))
                                <button type="submit" formaction="{{ route('cek-cuti.export') }}"
                                    class="btn btn-bnpb-secondary btn-mobile-fix flex-grow-1 flex-md-grow-0">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-2">
                                        <span
                                            class="badge bg-secondary bg-opacity-10 text-secondary border fw-normal">{{ $data['pegawai']->nip }}</span>
                                        <span
                                            class="badge bg-info bg-opacity-10 text-info border fw-normal">{{ $data['pegawai']->jenis }}</span>
                                        <span
                                            class="badge bg-success bg-opacity-10 text-success border fw-normal">{{ $data['pegawai']->golongan }}</span>
                                    </div>
                                    <p class="mb-1 text-dark fw-medium small">{{ $data['pegawai']->jabatan }}</p>
                                    <p class="mb-0 text-muted small"><i class="bi bi-building me-1"></i>
                                        {{ $data['pegawai']->unit_kerja }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        <div class="col-lg-4 fade-in-up delay-200">
                ...
                <div class="card card-hero shadow-lg h-100">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <h6 class="text-white-50 text-uppercase ls-1 mb-1"
                                    style="letter-spacing: 1px; font-size: 0.75rem;">Sisa Cuti Tahun {{ $data['tahun'] }}
                                </h6>
                                <h2 class="display-4 fw-bold mb-0">{{ $data['sisa_cuti'] }} <span
                                        class="fs-6 fw-normal">Hari</span></h2>
                            </div>
                        ...
                        @if (!empty($data['cpns_notice']))
                            <div class="p-3 mb-auto rounded-3 d-flex align-items-start"
                            ...
                            <div class="row g-2 mb-auto">
                                <div class="col-6">
                                    <div class="stat-box-light">
                                        <span class="d-block text-white-50 small" style="font-size: 0.7rem;">Jatah
                                            Dasar</span>
                                ...
                                <div class="col-6">
                                    <div class="stat-box-light">
                                        <span class="d-block text-white-50 small" style="font-size: 0.7rem;">Carry Over
                                            (Lalu)</span>
                                ...
                                <div class="col-6">
                                    <div class="stat-box-light">
                                        <span class="d-block text-white-50 small" style="font-size: 0.7rem;">Total
                                            Potensi</span>
                                ...
                                <div class="col-6">
                                    <div class="stat-box-light position-relative overflow-hidden">
                                        <span class="d-block text-white-50 small"
                                            style="font-size: 0.7rem;">Terpakai</span>
                        ...
                        <div
                            class="mt-3 pt-3 border-top border-white border-opacity-10 d-flex justify-content-between align-items-center">
            ...
            @else
                <div class="card card-custom text-center py-5 h-100 justify-content-center">
                    <div class="card-body">
                        <img src="https://cdn-icons-png.flaticon.com/512/7486/7486754.png" width="80"
                            class="opacity-25 mb-3">
                        <h6 class="text-muted">Data Kosong</h6>
                        <p class="small text-muted mb-0">
                            <span class="d-none d-lg-inline">Lakukan pencarian pegawai di kiri.</span>
                            <span class="d-lg-none">Lakukan pencarian pegawai di atas.</span>
                        </p>
                    </div>
                </div>
            @endif
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-history">
                        <div class="card card-custom">
                            <div class="card-header-custom d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-light text-secondary border fw-normal">{{ count($data['riwayat']) }}
                                    Data</span>
                            </div>
                                ...
                                <div class="table-responsive table-responsive-mobile">
                                    <table class="table align-middle mb-0 table-hover">
                                        <thead class="bg-light text-secondary">
                                            <tr>
                                                <th class="px-2 px-md-4 py-3 small fw-bold text-uppercase border-bottom">
                                                    Jenis Cuti</th>
                                                <th class="px-2 px-md-4 py-3 small fw-bold text-uppercase border-bottom">
                                                    Periode</th>

                                                <th
                                                    class="px-2 px-md-4 py-3 small fw-bold text-uppercase border-bottom text-center">
                                                    Durasi</th>
                                                <th
                                                    class="px-2 px-md-4 py-3 small fw-bold text-uppercase border-bottom text-center">
                                                    Dokumen</th>
                                        ...
                                        <tbody>
                                            @forelse($data['riwayat'] as $item)
                                                <tr>
                                                    ...
                                                    <td class="px-2 px-md-4 py-3 small text-muted col-nowrap">
                                                        <div class="d-flex flex-column">
                                                            <span><i class="bi bi-calendar-event me-1"></i>
                                                                {{ \Carbon\Carbon::parse($item->tanggal_mulai)->format('d M Y') }}</span>
                                                            <span class="text-xs text-secondary ms-3">s/d
                                                                {{ \Carbon\Carbon::parse($item->tanggal_selesai)->format('d M Y') }}</span>
                                                        </div>
                                                    </td>

                                                    <td class="px-2 px-md-4 py-3 text-center col-nowrap">
                                                        <span
                                                            class="badge bg-light text-dark border px-3 py-2 rounded-pill">{{ $item->lama_cuti }}
                                                            Hari</span>
                                                    </td>

                                                    <td class="px-2 px-md-4 py-3 text-center">
                                                        @php
                                                            $jenis = strtolower($item->jenis_cuti);
                                                            $bisaCetak = in_array($jenis, [
                                                                'cuti tahunan',
                                                                'cuti sakit',
                                                                'cuti alasan penting',
                                                                'cuti cap',
                                                        ...
                                                        @if ($bisaCetak)
                                                            <a href="{{ route('cetak.surat', ['id' => $item->id]) }}"
                                                                ...
                                                                <i class="bi bi-file-earmark-word-fill me-1"></i> <span
                                                                    class="d-none d-md-inline">Word</span>
                                                            </a>
                                                        @else
                                                    ...
                                                    <td class="px-2 px-md-4 py-3">
                                                        <span
                                                            class="badge bg-success bg-opacity-10 text-success badge-status border border-success border-opacity-25">
                                                            <i class="bi bi-check-circle-fill me-1"></i> <span
                                                                class="d-none d-md-inline">Disetujui</span><span
                                                                class="d-md-none">OK</span>
                                                        </span>
                                                    </td>
                                                </tr>
                                            @empty
                    ...
                    <div class="tab-pane fade" id="pills-stats">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="card card-custom h-100">
                                    <div class="card-header-custom"><i class="bi bi-pie-chart text-bnpb-orange"></i>
                                        Statistik Bulanan</div>
                                    <div class="card-body p-3">
                                        <div style="height: 300px; position: relative;"><canvas id="chartDonut"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card card-custom h-100">
                                    <div class="card-header-custom"><i class="bi bi-graph-up text-bnpb-orange"></i> Tren
                                        Jenis Cuti</div>
                                    <div class="card-body p-3">
                                        <div style="height: 300px; position: relative;"><canvas id="chartLine"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        // Loading State untuk Tombol Cari (Fitur Anda)
